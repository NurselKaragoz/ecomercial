...
function Blog() {
  return (
    <div>
      <div class=" pt-24 gap-3">
        <h6 class=" text-colors-blue">Practice Advice</h6>
        <h3 class=" text-colors-lacivert">Featured Posts</h3>
      </div>
      <div class="flex justify-center pt-5 gap-2">
        <div class="flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:max-w-xl md:flex-row">
          ...
          <div class="flex flex-col justify-start p-6">
            <h5 class="mb-2 text-xl font-medium text-neutral-800 dark:text-neutral-50 text-colors-blue">
              English Department
            </h5>
            <h5 class=" text-colors-lacivert">Graphic Desing</h5>
